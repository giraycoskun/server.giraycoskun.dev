  ...
  const commands: Command[] = [
    ...
    },
    {
      ...
      examples: [
        ...
        {
          code: 'ffmpeg -i input.mp4 -vf "scale=640:480" output.mp4',
          desc: "Resize video",
        },
        {
          code: 'ffmpeg -protocol_whitelist file,crypto,data,http,https,tls,tcp -i "http://example.com/stream/playlist.m3u8" -c copy -bsf:a aac_adtstoasc video.mp4',
          desc: "Download HLS stream",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      examples: [
        ...
        {
          code: "ss -tulnp | grep :PORT",
          desc: "To check if a port is in use",
        },
      ],
    ...
    },
    {
      ...
      examples: [
        ...
        {
          code: "chown -R user:group dir/",
          desc: "Recursive ownership change",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      examples: [
        { code: "nginx -t", desc: "Check Nginx config syntax" },
        {
          ...
          desc: "Reload Nginx after config changes",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      examples: [{ code: "sudo mount -a", desc: "Mount all filesystems" }],
    },
    {
      id: 26,
      category: "disk",
      ...
      <div className="bg-gray-900 text-white py-8 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-400 mb-3">
            ...
            <span>/</span>
            <span className="text-gray-200">Bash Commands</span>
          </div>
          ...
          <p className="text-gray-400">
            Quick reference for commonly used bash commands
          </p>
        </div>
      </div>
          ...
          {filteredCommands.map((cmd) => (
            ...
            >
              ...
              <div className="mb-3 bg-gray-900 rounded p-2 relative group">
                ...
                <button
                  onClick={() =>
                    copyToClipboard(cmd.syntax, `syntax-${cmd.id}`)
                  }
                ...
                {cmd.examples.map((ex, idx) => (
                  <div key={idx} className="bg-gray-50 rounded p-2">
                    <div className="flex items-start justify-between gap-2 mb-1 group">
                      ...
                      <button
                        onClick={() =>
                          copyToClipboard(ex.code, `ex-${cmd.id}-${idx}`)
                        }
